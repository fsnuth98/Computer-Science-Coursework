###--------------------------------------------------------------
### This module is an extension of sorts.py by John Zelle        
### sorts.py can be found here:                                   
### http://mcsp.wartburg.edu/zelle/python/ppics2/code/chapter13
###                                                             
### The original sorts.py contains the implementations of:
### Selection sort (selSort) and Merge Sort (mergeSort)
###
### This module also includes the implementations of:
### - Insertion Sort (insertSort)
### - Quick Sort (quickSort_)
###--------------------------------------------------------------

'''
CSC102 - Lab 05: Sorting Algorithms
Franklin Nuth
Rasul Rasulov
February 16th, 2018
'''
