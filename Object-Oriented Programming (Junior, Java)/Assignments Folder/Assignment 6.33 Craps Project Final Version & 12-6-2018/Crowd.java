...
{
    /*
    public String[] winResponsesa = {"Amazing roll!\n",
    ...
    */
    ...
    private int randomNumber = 1 + randomNumbersForCrowd.nextInt(3);
    ...
    public void getCrowdLoseResponse()
    {
        ...
        {
        System.out.printf("It's a no this time, chief. I think you'll do better next time.\n");
        }
    }
